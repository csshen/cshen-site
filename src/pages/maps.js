  ...
  render() {
    ...
    return(
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <VisitedStat visited={visited.us_states} stat='Total States'/>
        <Divider>North America</Divider>
        <WorldMap continent='northAmerica' color={['#3DD6D0', '#38C3BE']} />
        <VisitedStat visited={visited.north_america} stat='Total Countries'/>
        ...
        <VisitedStat visited={visited.europe} stat='Total Countries'/>
        <Divider>Asia</Divider>
        <WorldMap continent='asia' color={['#06D6A0', '#06C392']} />
        <VisitedStat visited={visited.asia} stat='Total Countries'/>
